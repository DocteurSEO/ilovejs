...
convas.id = 'confeti'
convas.style.width = '100%'
convas.style.height = '100%'
...
export function validation (getCodeColor){
   console.log(getCodeColor('rouge').length) 
 if(getCodeColor('rouge').length >= 6){
